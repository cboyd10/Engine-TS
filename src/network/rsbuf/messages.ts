...
export class PlayerInfoExactMove implements InfoMessage {
    ...
    encode(buf: Packet): void {
        buf.p1_alt1(this.startX);
        buf.p1_alt2(this.startZ);
        buf.p1_alt3(this.endX);
        buf.p1(this.endZ);
        buf.p2(this.begin);
