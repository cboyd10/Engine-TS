...
import FishingCatchChanceEncoder from '#/network/game/server/codec/FishingCatchChanceEncoder.js';
...
class ServerGameProtRepository {
    ...
    constructor() {
        ...
        this.bind(FishingCatchChance, new FishingCatchChanceEncoder());
